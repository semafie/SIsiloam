 ...
 * @author RESCOM-1
 */
public class kirimkodever extends javax.swing.JPanel {
...
public void kirim()throws AddressException, MessagingException {
    ...
    String to      = "debbyazzahra05@gmail.com" ;
...
"</html>";
    ...
    private void initComponents() {
        ...
        add(inputusername);
        inputusername.setBounds(491, 362, 390, 50);
        ...
        add(btnkir);
        btnkir.setBounds(470, 510, 426, 70);
...
//        }
            ...
            Logger.getLogger(kirimkodever.class.getName()).log(Level.SEVERE, null, ex);
